...
public class DebugWithH2 {
    private static final Logger logger = LoggerFactory.getLogger(DebugWithH2.class);

    public static void main(String[] args) {
        ApplicationContext ac = new ClassPathXmlApplicationContext("debug-context-h2.xml");
//        testOne(ac);
//        testGroup(ac);
